...
((OLD.laua_seisundi_liik_kood=NEW.laua_seisundi_liik_kood) OR
 (OLD.laua_seisundi_liik_kood=1 AND
NEW.laua_seisundi_liik_kood=2) OR
(OLD.laua_seisundi_liik_kood=2 AND
NEW.laua_seisundi_liik_kood=3) OR 
(OLD.laua_seisundi_liik_kood=3 AND
NEW.laua_seisundi_liik_kood=2) OR
 (OLD.laua_seisundi_liik_kood  IN (2, 3) AND
NEW.laua_seisundi_liik_kood=4)))
...
DROP TRIGGER laud_reg_aeg_muutmine_keelatud ON laud;
DROP TRIGGER laud_registreerija_muutmine_keelatud ON laud; 
DROP TRIGGER laud_vale_seisundiliigi_muutus ON laud;
