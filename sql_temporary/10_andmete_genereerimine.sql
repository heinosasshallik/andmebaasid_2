/*
Genereeri 2000 rida andmeid tabelisse laud.
*/
    ...
    SELECT
     ...
     FROM (
        SELECT
     	...
     	FROM generate_series(1,2000) AS generator
     ) AS sisestatavad_read
ON CONFLICT DO NOTHING;

/*
Genereeri 8000 rida andmeid tabelisse laua_kategooria_omamine, sest tekib palju konflikte ja eesmärk on
    ...
    SELECT
     ...
     FROM (
        SELECT
     	...
     	FROM generate_series(1,8000) as generator
     ) as sisestatavad_read
ON CONFLICT DO NOTHING;